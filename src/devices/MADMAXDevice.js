...
export class MADMAXDevice {
  ...
  update(dt){
    ...
    else if(this.elapsed<13000)this.state="falling";
    else if(this.elapsed<14000)this.state="overflow-tail";
    else if(this.elapsed<17000)this.state="settling";
    else{this.state="idle";this.elapsed=0;}
  }

  get busy(){return this.state!=="idle";}
  get pressed(){return this.state==="pressed";}
  get falling(){return this.elapsed>=3000&&this.elapsed<13000&&this.state!=="pressed"&&this.state!=="idle";}
  get overflowHolding(){return this.elapsed>=5000&&this.elapsed<14000&&this.state!=="pressed"&&this.state!=="idle";}
  ...
  get fallStrength(){
    ...
    const end=1-smooth((this.elapsed-12650)/350);
    return start*end;
  }
  get settlingStrength(){return this.state==="settling"?1-clamp((this.elapsed-14000)/3000):0;}
}
