...
export class PoolRenderer {
  ...
  #handrail(ctx,w,h,g){
    ...
    this.#railRightEdges(ctx,w,frontBase,nearJoin,farX,farBaseY,farShoulder,railStart,railWidth);
  }

  #railRightEdges(ctx,w,frontBase,nearJoin,farX,farBaseY,farShoulder,railStart,railWidth){
